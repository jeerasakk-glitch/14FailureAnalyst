...
def init_vdb():
    try:
        ...
        # รองรับ ChromaDB ทั้งเก่าและใหม่ (list_collections คืน object หรือ string)
        try:
        ...
        err_msg = str(e)
        # ChromaDB schema เก่าไม่ตรงกับ version ใหม่ → ลบและสร้างใหม่
...
def inject_css():
    st.markdown("""
    <style>
    /* ซ่อนปุ่มดวงตาในช่อง Password — รองรับทุก Streamlit version */
...
# ============================================================
def main():
    inject_css()  # ← inject CSS ก่อน sidebar render เพื่อซ่อนปุ่มดวงตา
